	...
	<section class="section-slide">
            <div class="wrap-slick1">
                <div class="slick1">
                    ...
                    <div class="item-slick1 item3-slick1" style="background-image: url({!! asset('images/slide1-01.jpg') !!});">
                        <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                            <span class="caption1-slide1 txt1 t-center animated visible-false m-b-15" data-appear="rotateInDownLeft">
                                ร่วมพูดคุย แบ่งปันความคิดเห็น ร่วมกัน
                            </span>
                    ...
                    <div class="item-slick1 item1-slick1" style="background-image: url({!! asset('images/slide1-02.jpg') !!});">
                        <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                            <h4 class="caption1-slide1 tit1 t-center animated visible-false m-b-18" data-appear="fadeInDown">
                                Log in for join us
                            </h4>

                            <h4 class="caption2-slide1 tit1 t-center animated visible-false m-b-37" data-appear="fadeInDown">
                                or
                            </h4>
